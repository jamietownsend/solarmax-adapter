...
public class SolarmaxConnector {
    ...
    private static String getCommandString(List<String> commandList) {
    ...
    private static Map<String, String> getValuesFromSolarmax(final Socket socket, final int deviceAddress,
