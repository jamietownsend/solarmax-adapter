...
public class ArrayManager {
    ...
    private static final Set<SolarmaxDevice> solarmaxDevices = new HashSet<SolarmaxDevice>(Arrays
            .asList(new SolarmaxDevice("192.168.1.151", 12345, 1), new SolarmaxDevice("192.168.1.152", 12345, 2)));
    ...
    /**
     * @return the current power generation details
     */
    public static List<PowerGenerationDetail> getCurrentPowerGenerationDetails() {
        List<PowerGenerationDetail> returnArray = new ArrayList<PowerGenerationDetail>();
        for (SolarmaxDevice solarmaxDevice : solarmaxDevices) {
            returnArray.add(solarmaxDevice.getPowerGenerationDetails());
        }
