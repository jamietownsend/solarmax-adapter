...
public class SolarmaxCommand {
    ...
    public SolarmaxCommand(final int number, final SolarmaxCommands.SolarmaxCommandKey key, final String description, final String something) {
        this.number = number;
        this.key = key;
